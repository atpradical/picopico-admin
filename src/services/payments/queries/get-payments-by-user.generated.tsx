...
export type GetPaymentsByUserQuery = { __typename?: 'Query', getPaymentsByUser: { __typename?: 'PaymentPaginationModel', totalCount: number, pageSize: number, page: number, pagesCount: number, items: Array<{ __typename?: 'SubscriptionByPaymentModel', dateOfPayment?: any | null, id: string, type: Types.SubscriptionType, endDate?: any | null, price: number, paymentType?: Types.PaymentMethod | null }> } };
